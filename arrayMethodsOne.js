...
// CODE HERE
const postTaxPrices = prices.map((element, index, wholeArray) => element * 1.07);
...
// CODE HERE
const orderTotal = orders.map(element => element.price * (element.tax + 1))
...
// CODE HERE
const bobsTotal = purchases.filter(element => element.owner.includes("Bob")).reduce((acc, cur) => acc + cur.price, 0)
