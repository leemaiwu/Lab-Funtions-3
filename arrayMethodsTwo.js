...
// CODE HERE
const newNumbersArr = numbers.map(num => num / 2)
...
// CODE HERE
const endsWithI = cities.filter(element => element.endsWith("i"))
...
// CODE HERE
const foodWithRice = foods.filter(element => element.tags.includes("rice")).reduce((acc, cur) => acc + cur.price, 0)
